const DoctorInfoCard = ({ doctor }) => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl mb-10 overflow-hidden">
      <div className="bg-gradient-to-r h-32" />
      <div className="relative px-6 md:px-10 pb-10 -mt-20">
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="relative">
            <img
              src={doctor.avatarUrl || "/default-doctor-avatar.png"}
              alt={doctor.name}
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
              {doctor.name}
              {doctor.isVerified && (
                <img src="/verified-icon.png" alt="Verified" className="w-6 h-6" />
              )}
            </h2>
            ...
            <div className="mt-4 text-right">
              <span className="text-3xl font-bold text-blue-600">${doctor.fees}</span>
